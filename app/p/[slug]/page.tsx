...
export default function Product({ params }){
  ...
  function buy(){
    if(CHECKOUT.includes('COLE_AQUI')) { alert('Configure o link de checkout (const CHECKOUT)'); return }
  ...
  return (<section className="container py-8 grid md:grid-cols-2 gap-8">
    ...
    <div>
      ...
      <div className="mt-4 space-y-3">
        ...
        <ul className="text-sm text-neutral-600 list-disc ml-5">
          <li>Garantia de 7 dias</li>
          <li>Envio em 24h úteis</li>
